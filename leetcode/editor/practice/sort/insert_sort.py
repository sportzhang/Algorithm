...
(2)j=0,a[j]<value,说明value应该在j=0之后，插入此位置：a[1]=value
...
def insert_sort(array):
    ...
    for i in range(1, n):
        ...
        while j >= 0 and array[j] > value:
            ...
            j -= 1
            print("j: ", j)
        array[j+1] = value  # 发现小于value的元素，则结束比较，将待插入值value插入到位置j之后，因为此时j位置值小于value.
    return array


"""
冒泡排序：每次讲一个元素放置到正确的位置，则对于大小为n的数组，进行n次循环即可将所有元素排序。
"""
